 ...
 */
__DOCA_EXPERIMENTAL
void doca_telemetry_schema_set_buffer_size(struct doca_telemetry_schema *doca_schema, uint64_t size);
 ...
 */
__DOCA_EXPERIMENTAL
doca_error_t doca_telemetry_schema_get_buffer_size(struct doca_telemetry_schema *doca_schema, uint64_t *size);
 ...
 */
__DOCA_EXPERIMENTAL
void doca_telemetry_schema_set_buffer_data_root(struct doca_telemetry_schema *doca_schema, const char *path);
 ...
 */
__DOCA_EXPERIMENTAL
doca_error_t doca_telemetry_schema_get_buffer_data_root(struct doca_telemetry_schema *doca_schema, const char **path);
 ...
 */
 __DOCA_EXPERIMENTAL
void doca_telemetry_field_set_array_length(struct doca_telemetry_field *field_info, uint16_t len);
