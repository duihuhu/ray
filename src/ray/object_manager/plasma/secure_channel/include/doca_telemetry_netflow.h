 ...
 * doca_telemetry_netflow_field_set_length(field1. DOCA_NETFLOW_IPV4_SRC_ADDR_DEFAULT_LENGTH);
 *
 * doca_telemetry_netflow_field_set_type(field1, DOCA_NETFLOW_IPV4_DST_ADDR);
 * doca_telemetry_netflow_field_set_length(field1. DOCA_NETFLOW_IPV4_DST_ADDR_DEFAULT_LENGTH);
 *
 ...
 */
 __DOCA_EXPERIMENTAL
void doca_telemetry_netflow_field_set_length(struct doca_telemetry_netflow_flowset_field *field,
												uint16_t length);
 ...
 */
__DOCA_EXPERIMENTAL
void doca_telemetry_netflow_set_buffer_size(uint64_t size);
 ...
 */
__DOCA_EXPERIMENTAL
void doca_telemetry_netflow_set_buffer_data_root(const char *path);
