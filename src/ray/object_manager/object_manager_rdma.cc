...
int ObjectManagerRdma::PollCompletion(struct pingpong_context *ctx, const absl::optional<plasma::Allocation> &allocation, const ray::ObjectInfo &object_info, const ray::raylet::DependencyManager &dependency_manager, int64_t start_time){
